        ...
        [
            {
                ...
                "formula":"HARM($TARGET,P,GET_PROP($CASTER,B_DMG)+10+GET_PROP($CASTER,STR)/2)",
                "needed_level":1
            },
            ...
        ]
...
* `"formula":"HARM($TARGET,P,GET_PROP($CASTER,B_DMG)+10+GET_PROP($CASTER,STR)/2)",` - The script that details what the skill does.
        ...
        [
            {
                ...
                "push_back":"3",
                "interrupt":"true",
                "formula":"HEAL($CASTER,10+GET_PROP($CASTER,INT)*5)",
                "needed_level":5,
        ...
        [
            {
                "cooldown":"1200",
                "duration":"60",
                "formula":"HARM($TARGET,P,GET_PROP($CASTER,B_DMG)+GET_PROP($CASTER,STR)/2)",
                "needed_level":15,
